...
public class CreateSequentialFile
{
   ...
   public static void openFile()
   {
      try 
      {
         output = new ObjectOutputStream(
            Files.newOutputStream(Paths.get("src\\clients.ser")));
          /*output = new ObjectOutputStream(
          new FileOutputStream("clients2.ser"));*/ // gsjung
   ...
   public static void addRecords()
   {
      ...
      System.out.printf("%s%n%s%n? ", 
         "Enter ID, account number, first name, last name and balance.",
      ...
      while (input.hasNext()) // loop until end-of-file indicator
      {
         try 
         {
            ...
            Account record = new Account(input.nextInt(), input.nextInt(),
